...
public class Data // 씬 이동시 데이터 저장할 것들
{
    ...
    public bool[] ZoneLight = new bool[] {true, true, true, true, true, true, true, true, true, true,
         ...
         true,true,true,true,true,true,true,true,true,true,
         true,true,true,true,true,true,true,true,true,true,
         true,true,true,true,true,true}; // 56개 중 어느것이 사용될지 모르므로 56개 모두 참으로 만듬(안쓰는 것들은 참) 쓰는것만 참/거짓으로 바뀜

    public bool[] Alarm_weekday = new bool[] { false, false, false, false, false, false, false }; // 알람 요일 체크 true/false
    ...
    public string Devel_COM; // 개발자모드 아두이노 COM 입력 (포트)

    public string Open_Hour; // 개장시간, 분, 초, am/pm 나타내는 변수
